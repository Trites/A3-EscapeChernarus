...
private ["_villagePatrolSpawnArea","_EnemyCount","_pos","_enemyMinSkill", "_enemyMaxSkill", "_enemySpawnDistance", "_playerGroup", "_enemyFrequency", "_comCenGuardsExist", "_fenceRotateDir", "_scriptHandle"];
...
[A3E_StartPos, _backPack, _enemyFrequency, _fenceRotateDir] spawn {
	...
	_backPack addWeaponCargoGlobal ["CUP_glaunch_M79",1];
	_backPack addMagazineCargoGlobal["CUP_FlareRed_M203", 1];
	_backPack addMagazineCargoGlobal["CUP_1Rnd_StarCluster_Red_M203", 2];
